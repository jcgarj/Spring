...
public enum CfgQueries {
    QUERY_ROUTER("GET_PE_CML_OPER_ROUTER"),
    ...
    //Ambientes de datos
    GET_DS_ALL_INFO("GET_DS_ALL_INFO"),
    GET_DS_INFO_BY_PROJECT("GET_DS_ALL_INFO"),
    GET_DS_INFO_BY_CLIENT("GET_DS_ALL_INFO"),
    GET_ALL_CLIENTS("GET_ALL_CLIENTS"),
    GET_CLIENT_BY_ID("GET_CLIENT_BY_ID"),
    DELETE_CLIENT_BY_ID("DELETE_CLIENT_BY_ID"),
    SET_CLIENT("SET_CLIENT"),
    UPDATE_CLIENT("UPDATE_CLIENT"),
    GET_ALL_ENVIROREMENTS("GET_ALL_ENVIROREMENTS"),

    //WarMachine
    GET_ALL_INFO_PARAMETERS("GET_ALL_INFO_PARAMETERS"),
    GET_PATH_MATRIX("GET_PATH_MATRIX"),
    GET_SERVICE_ID("GET_SERVICE_ID"),
    GET_TAGS_NAMES("GET_TAGS_NAMES"),
    GET_URL_SERVICE("GET_URL_SERVICE"),
    SET_RESULTS_TESTING("SET_RESULTS_TESTING"),
